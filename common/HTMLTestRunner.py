...
<!DOCTYPE template_pages PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<template_pages xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>%(title)s</title>
    <meta name="generator" content="%(generator)s"/>
    <meta http-equiv="Content-Type" content="text/template_pages; charset=UTF-8"/>
...
<tr id='header_row' class="panel-title">
    <td>Test Group/Test case_data</td>
    <td>Count</td>
    <td>Pass</td>
    <td>Fail</td>
    <td>Error</td>
...
class _TestResult(TestResult):
    ...
    # It lacks the output and reporting ability compares to my_unittest._TextTestResult.
    ...
    def stopTest(self, test):
        ...
        # But there are some path in my_unittest that would bypass this.
...
class HTMLTestRunner(Template_mixin):
    ...
    def run(self, test):
        """Run the given test case_data or test suite."""
    ...
    def sortResult(self, result_list):
        # my_unittest does not seems to run in any particular order.
...
# Note: Reuse my_unittest.TestProgram to launch test. In the future we may
# build our own launcher to support more specific command line
# parameters like test title, CSS, etc.
class TestProgram(unittest.TestProgram):
    """
    A variation of the my_unittest.TestProgram. Please refer to the base
