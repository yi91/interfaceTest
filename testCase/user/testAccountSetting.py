...
localLogin_xls = commondef.get_xlsx("userCase.xlsx")
localAccountSetting_xls = commondef.get_xlsx("userCase.xlsx")
...
class AccountSetting(unittest.TestCase):
    ...
    def testAccountSetting(self):
        ...
        """
        # set url
        self.url = commondef.get_url_from_xml('accountSetting')
    ...
    def checkResult(self):
        ...
        if self.result == '0':
            ...
            result = self.info['info'].get('report')
