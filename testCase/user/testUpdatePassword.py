...
from common import configHttp, readConfig as readConfig
...
localUpdatePassword_xls = commondef.get_xls("userCase.xlsx", "updatePassword")
...
class UpdatePassword(unittest.TestCase):
    ...
    def testUpdatePassword(self):
        ...
        # set url
        self.url = commondef.get_url_from_xml('updatePassword')
